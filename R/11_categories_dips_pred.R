...
writeRaster(cu_rich_pred, "./Richness/Categories/cu_rich_pred_categ.tif",
...
writeRaster(fu_rich_pred, "./Richness/Categories/fu_rich_pred_categ.tif",
            format="GTiff", overwrite=T)
...
writeRaster(cu_rich_disp, "./Richness/Categories/cu_rich_disp_categ.tif",
            format="GTiff", overwrite=T)
...
writeRaster(fu_rich_disp, "./Richness/Categories/fu_rich_disp_categ.tif",
            format="GTiff", overwrite=T)
...
p <- ggplot(df2, aes(x=categ, y=value, fill=variable)) +
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 65), breaks = c(0,20,40,60))
