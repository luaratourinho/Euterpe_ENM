...
writeRaster(cu_rich_pred, "./Richness/Categories/LUH/cu_rich_pred_categ_comCerrado.tif",
...
writeRaster(fu_rich_pred, "./Richness/Categories/LUH/fu_rich_pred_categ_comCerrado.tif",
            format="GTiff", overwrite=T)
...
writeRaster(cu_rich_disp, "./Richness/Categories/LUH/cu_rich_disp_categ_comCerrado.tif",
            format="GTiff", overwrite=T)
...
writeRaster(fu_rich_disp, "./Richness/Categories/LUH/fu_rich_disp_categ_comCerrado.tif",
            format="GTiff", overwrite=T)
...
ggsave(
  g_arrange,
  file = "./Figures/Categories_LUH_com_Cerrado.tiff",
  height = 10,
  width = 20,
  units = "cm"
)
