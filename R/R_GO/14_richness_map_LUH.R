...
writeRaster(cu_rich_disp, filename = paste0("./Richness/LUH/cu_rich_disp.tif"),
            format="GTiff", overwrite=T)
writeRaster(fu_rich_disp, filename = paste0("./Richness/LUH/fu_rich_disp.tif"),
            format="GTiff", overwrite=T)
...
writeRaster(cu_rich_pred, filename = paste0("./Richness/LUH/cu_rich_pred.tif"),
            format="GTiff", overwrite=T)
writeRaster(fu_rich_pred, filename = paste0("./Richness/LUH/fu_rich_pred.tif"),
            format="GTiff", overwrite=T)
